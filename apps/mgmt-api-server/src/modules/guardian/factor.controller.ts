...
import { FactorDto, FactorProviderDto, FactorConfigDto } from "libs/api/infra-api/src/guardian/factor/factor.dto";
import { Scopes } from "libs/oidc/client/src/lib/guards/scopes.decorator";
import { IConfigService } from "libs/api/infra-api/src/config/config.service";
import { plainToClass } from "class-transformer";
import { ConfigDto } from "libs/api/infra-api/src/config/config.dto";
import { TenantGuard } from "../../middleware/tenant.guard";
import { IRequestContext, ReqCtx } from "@libs/nest-core";
import { ConfigService } from "@nestjs/config";

@Controller('/api/v1/guardian/factors')
