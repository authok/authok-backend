...
@Controller('/api/v1/tenants/invitations')
export class TenantInvitationController {
  ...
  async sendInvitation(
    ...
    return await this.invitationService.create({ tenant }, invitation);
  }
  ...
  async listInvitations(
    ...
    return await this.invitationService.paginate({ tenant }, { ...query, org_id: ctx.tenant });
  }
