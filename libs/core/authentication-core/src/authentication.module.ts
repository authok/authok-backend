  ...
  providers: [
    ...
    PasswordRealmAuthenticationHandler,
    {
      ...
      useFactory: (
        ...
        Logger.debug(
          'register authenticationHandler: http://authok.cn/oauth/grant-type/password-realm',
        );
        ...
        Logger.debug(
          'register authenticationHandler: http://authok.cn/oauth/grant-type/passwordless/otp',
        );
