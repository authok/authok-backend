...
import { UserCreatedEvent, LoginEvent, UserEvents } from 'libs/api/infra-api/src/user/user.event';
import { NotificationManager } from 'libs/core/notifications-core/src/notification.manager';
...
export class UserEventHandler {
  ...
  async handleUserCreatedEvent(event: UserCreatedEvent) {
    ...
    if (user.password) {
      ...
      const usedPassword: Partial<PasswordHistoryDto> = {        
