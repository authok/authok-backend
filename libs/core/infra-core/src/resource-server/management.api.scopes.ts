export const managementApiScopes = [
  { value: 'read:groups', description: '读取分组' },
  { value: 'update:groups', description: '更新分组' },
  { value: 'delete:groups', description: '删除分组' },
  { value: 'create:groups', description: '创建分组' },
  ...
  { value: 'read:users', description: '读取用户' },
  { value: 'update:users', description: '更新用户' },
  { value: 'delete:users', description: '删除用户' },
  { value: 'create:users', description: '创建用户' },
  {
