...
export class Init1723470447251 implements MigrationInterface {
    name = 'Init1723470447251'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "client_grants" ("id" character varying(48) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "client_id" character varying(32) NOT NULL, "tenant" character varying(36) NOT NULL, "audience" character varying(256) NOT NULL, CONSTRAINT "idx_clientgrant_client_resource_server" UNIQUE ("tenant", "client_id", "audience"), CONSTRAINT "PK_ba696646fd265617c80d0dd94f7" PRIMARY KEY ("id"))`);
