...
export class Init1722943321591 implements MigrationInterface {
    name = 'Init1722943321591'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "branding_entity" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "colors" text, CONSTRAINT "PK_30dca56901d99a3ae0e54e8d8a1" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "organizations" ADD CONSTRAINT "FK_ab00f9de6dd9a9775c2d94d9dc7" FOREIGN KEY ("fk_branding_id") REFERENCES "branding_entity"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TABLE "branding_entity"`);
