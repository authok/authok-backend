...
export class UserController {
  ...
  @Get('/:user_id')
  @ApiOperation({ description: '根据ID查找用户', summary: '根据ID查找用户' })
  @ApiOkResponse({
    type: UserDto,
  })
  @Scopes('read:users')
  ...
  @Post()
  @ApiOperation({ description: '创建新用户', summary: '创建新用户' })
  @ApiOkResponse({
    type: UserDto,
  })
  @Scopes('create:users')
  ...
  @ApiOperation({
    description: '根据身份提供者的用户ID查找用户',
    summary: '根据身份提供者的用户ID查找用户',
  })
  @ApiOkResponse({
    type: UserDto,
  })
  ...
  @ApiParam({ name: 'user_id', description: '用户ID' })
  ...
  @ApiParam({ name: 'user_id', description: '主账户ID' })
  @ApiOperation({ summary: '连接两个账户组成一个主从关系' })
  ...
  @ApiOkResponse({
    type: pageDtoFactory(OrganizationDto),
  })
  @ApiParam({ name: 'user_id', description: '用户ID' })
  @Scopes('read:users')
